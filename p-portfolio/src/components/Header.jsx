    ...
    return (
        <div className="h-full flex flex-col items-center justify-center p-6">
            ...
            >
                ...
                >
                    <div className="mb-6 px-5 py-2 rounded-full border border-zinc-200/50 dark:border-white/10 bg-white/70 dark:bg-black/50 backdrop-blur-md flex items-center gap-2.5 shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:shadow-none hover:scale-105 transition-transform duration-300">
